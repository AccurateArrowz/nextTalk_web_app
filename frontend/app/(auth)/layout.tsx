    ...
    <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-br from-indigo-950 via-slate-900 to-slate-950 px-4 py-12">
      ...
      <div className="mb-8 flex flex-col items-center gap-2 z-10">
        <div className="flex items-center gap-2.5">
          {/* Logo icon */}
          <span className="flex items-center justify-center w-10 h-10 rounded-xl bg-indigo-500 shadow-lg shadow-indigo-500/40">
            <svg
        ...
        <p className="text-slate-400 text-sm">Real-time chat, reimagined.</p>
      </div>
